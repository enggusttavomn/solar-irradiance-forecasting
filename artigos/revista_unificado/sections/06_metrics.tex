...
percent explicitly multiply it by 100. Mean normalization supports comparison
among sites with different mean irradiance levels \cite{voyant2022}.
From Eq.~\eqref{eq:nrmse}, a small denominator makes this ratio unstable.
The value is therefore left undefined
...
negative when the forecast is worse than the evaluation-mean predictor. Higher values are better;
