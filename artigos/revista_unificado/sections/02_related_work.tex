...
evaluation design \cite{hewamalage2021}. Zhu et al.\ \cite{zhu2024} extended
this comparison to seasonal and climate context, evaluating several deep
time-series models across horizons from minutes to 24~h and seasons, with
different input combinations and training-set lengths. Such designs
