...
Training and inference times were not instrumented consistently in the
completed runs. They are therefore not reconstructed from file timestamps,
epoch counts, hardware assumptions, or checkpoint sizes. The comparison
reports exact architectural capacity and the common one-thread execution
policy, while treating measured runtime as unavailable evidence rather than a
quantity to be estimated retrospectively.
