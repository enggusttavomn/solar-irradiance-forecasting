...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.90\textwidth]{heterogeneidade_local_delta_mae.pdf}
...
monthly task. Both monthly advantages are thus more consistent across the
retained initializations than the terminal daily advantage, but neither is
universal. Seed standard deviations
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{variabilidade_arquiteturas.pdf}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{previsoes_casos_contrastantes.pdf}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{perfis_sete_dias.pdf}
