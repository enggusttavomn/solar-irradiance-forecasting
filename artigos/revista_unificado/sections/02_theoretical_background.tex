...
feeds one-step predictions back as inputs, which can accumulate error as the
horizon increases \cite{guariso2020}. The forecasting strategy must therefore
be held constant when comparing models. A local model estimates separate parameters for each
...
observations without downsampling. An output head maps the resulting states to one or
