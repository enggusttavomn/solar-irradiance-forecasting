...
Solar irradiance &
Multiple weather parameters; individual variables not verified &
TimesNet &
Long-term in the title; numerical horizon, resolution, sites, and split pending full-text verification \\
...
2DTFM &
Multi-scale forecasting; full horizon and split details pending verification \\
\bottomrule
\end{tabular}
\par\medskip
