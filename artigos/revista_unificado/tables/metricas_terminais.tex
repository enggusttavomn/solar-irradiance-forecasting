\begin{table*}[htbp]
\centering
\caption{Terminal cumulative metrics for TimesNet and DilatedRNN, averaged equally across sites. Daily and monthly results evaluate the five-seed ensemble; hourly results use seed 42. MAE and RMSE are in W/m$^2$; nRMSE is reported as a percentage.}
